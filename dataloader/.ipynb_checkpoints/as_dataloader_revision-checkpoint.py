...
#from torchvideotransforms.video_transforms import ColorJitter
import random
...
class AorticStenosisDataset(Dataset):
    def __init__(self, dataset_root: str = '~/as', view: str = 'plax',
                 split: str = 'train',
                 transform: bool = True, normalize: bool = False, 
    ...
    def __getitem__(self, item):
        ...
        # else:
        #     if self.contrstive == 'SupCon' or self.contrstive =='SimCLR':
        #         cine_aug = self.transform_contrastive(cine)
        #         upsample = nn.Upsample(size=(16,224, 224), mode='nearest')
        #         cine_aug = cine_aug[:, :,  0:180, 40:180].unsqueeze(1)
        #         cine_aug = upsample(cine_aug).squeeze(1)
        ...
        if self.normalize:
            ...
            if (self.contrstive == 'SupCon' or self.contrstive =='SimCLR') and self.split == 'train':
