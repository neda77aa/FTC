...
class Network(object):
    ...
    def test(self, loader_te, mode="test"):
        ...
        for data in tqdm(loader_te):
            ...
            argm_view, _, _, _, _, _ = self._get_prediction_stats(pred_view, self.num_classes_view)
            conf_AS = utils.update_confusion_matrix(conf_AS, target_AS.cpu(), argm_AS.cpu())
            conf_view = utils.update_confusion_matrix(conf_view, target_view.cpu(), argm_view.cpu())
