...
class WideResNet(nn.Module):
    def __init__(self, first_stride, num_classes_diagnosis ,num_classes_view , depth=28, widen_factor=2, drop_rate=0.0, is_remix=False):
        ...
        self.fc_view = nn.Linear(channels[3], num_classes_view)
        self.fc_diagnosis = nn.Linear(channels[3], num_classes_diagnosis)
...
class build_WideResNet:
    ...
    def build(self, num_classes_diagnosis, num_classes_view):
        return WideResNet(
            first_stride=self.first_stride,
            depth=self.depth,
            num_classes_diagnosis = num_classes_diagnosis,
            num_classes_view = num_classes_view,
